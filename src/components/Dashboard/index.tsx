...
import { AlertEventsCard } from './AlertEventsCard';
import { Setup } from '../Setup';
import { AlertEvent, AlertRuntimeStatus, api, ServiceStatus, isTauri } from '../../lib/tauri';
...
export function Dashboard({ envStatus, onSetupComplete, alertEvents, alertRuntimeStatus }: DashboardProps) {
  ...
  return (
    <div className="h-full overflow-y-auto scroll-container pr-2">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <AlertEventsCard events={alertEvents} runtimeStatus={alertRuntimeStatus} />
        </motion.div>
